...
> Discord to-do list bot, tasks projects team assignments 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

✅ &nbsp;**Tasks** — create and manage tasks in Discord

📋 &nbsp;**Projects** — organize tasks into projects

👥 &nbsp;**Assign** — assign tasks to team members

⏰ &nbsp;**Deadlines** — due dates with reminders

📊 &nbsp;**Progress** — completion percentage per project

🔄 &nbsp;**Recurring** — daily, weekly repeating tasks
